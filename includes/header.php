...
$is_skills = $request_path === '/skills' || $request_path === '/skills.php' || strpos($request_path, '/public-geo-skills') === 0;
?>
    ...
    <div class="site-container px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="hidden md:flex items-center space-x-6">
                ...
                <a href="/skills" class="flex items-center text-sm font-medium <?php echo $is_skills ? 'text-gray-900' : 'text-gray-600 hover:text-gray-900'; ?>">
        ...
        <div id="mobileMenu" class="mobile-panel md:hidden hidden border-t border-gray-100 py-4">
            <nav class="flex flex-col space-y-4">
                ...
                <a href="/skills" class="mobile-nav-link flex items-center text-sm font-medium <?php echo $is_skills ? 'text-gray-900' : 'text-gray-600 hover:text-gray-900'; ?>">
