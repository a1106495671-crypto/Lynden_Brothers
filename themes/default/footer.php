...
$footer_copyright_text = function_exists('site_setting_value')
    ? site_setting_value('copyright_info', site_setting_value('copyright_text', '© 2025 ' . SITE_FULL_NAME . '. All rights reserved.'))
    : get_setting('copyright_text', '© 2025 ' . SITE_FULL_NAME . '. All rights reserved.');
?>
