                ...
                if (!empty($article_ids) && !empty($review_status)) {
                    try {
                        ...
                        foreach ($article_ids as $article_id) {
                            ...
                            $stmt->execute([$article_id, $admin_id, $review_status, $review_note]);
                            if ($workflowState['status'] === 'published') {
                                $publishedArticleIds[] = (int) $article_id;
                            }
                        }
                        ...
                        foreach ($publishedArticleIds as $publishedArticleId) {
                            $autoDistribution = distribution_handle_article_published($db, $publishedArticleId);
