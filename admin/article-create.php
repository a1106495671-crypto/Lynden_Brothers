        ...
        try {
            ...
            if ($title === '') {
                ...
                if ($result) {
                    ...
                    if ($status === 'published') {
                        distribution_handle_article_published($db, (int) $article_id);
                    }
...
<script>
    ...
    document.getElementById('content-textarea-split').addEventListener('input', function () {
        document.getElementById('content-textarea').value = this.value;
        updatePreview();
    });
</script>
